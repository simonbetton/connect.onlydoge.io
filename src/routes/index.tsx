...
function App() {
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-10 sm:px-6">
      <section className="relative overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-primary via-background to-primary/60 p-8 shadow-sm">
