...
const MOCK_ISSUED_TIMESTAMP = "2026-01-01T00:00:00Z"
...
const createMockPayment = (paymentId: string): ConnectPaymentWire => ({
  type: "payment",
  id: paymentId,
  issued: MOCK_ISSUED_TIMESTAMP,
  timeout: MOCK_TIMEOUT_SECONDS,
  relay: "https://relay.onlydoge.dev/mock",
  ...
  vendor_address: "",
  vendor_url: "https://onlydoge.dev",
  vendor_order_url: `https://onlydoge.dev/order/${paymentId}`,
